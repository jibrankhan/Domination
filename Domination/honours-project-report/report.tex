...
\hline
Failed-Occupation & attackerName, continentName, territoryName & Signals that \textit{attackerName} performed a FailedOccupation. \\ 
\hline
Successful-Defence & defenderName, continentName, territoryName & Signals that \textit{defenderName} performed a SuccesfulDefence. \\ 
\hline
Failed-Defence & defenderName, continentName, territoryName & Signals that \textit{defenderName} performed a FailedDefence. \\ 
\hline
Army-Movement & playerName, continentName, territoryName & Signals that \textit{playerName} performed an ArmyMovement. \\ 
\hline
