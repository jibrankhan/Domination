...
Michael Wolf at the University of  wrote a paper titled "Development of an Intelligent Artificial Player for the Game of Risk" \textbf{[ref]} in where he claims R.I.S.K. is generally well known, but under recognised by academia. He then went on to prove that the state space for R.I.S.K is in fact infinite. 

Other work includes that of efforts by undergraduate/graduates at Stanford on an A.I. \textbf{[ref]} agent to play R.I.S.K. They say R.I.S.K. is an interesting opportunity as it is an "intersection between traditional and modern board games".
...
\hline
FailedAttack & attackerName, continentName, territoryName & Signals that \textit{attackerName} performed a FailedAttack. \\ 
\hline
...
From Table 7.1 we see that \textit{constrained play has a significantly higher accuracy than the other types of play}. This finding is unsurprising as due to the artificial nature of constrained play, players only performed directly-consistent actions whereas in Free and A.I. play, players did not. 

Most definitely a more natural method of playing, players in Free and A.I. play perform actions that are either indirectly-consistent or inconsistent  because their plan at that point is different to that of their mission. What is interpret though is. Either actions reduce the predicted probability of the correct explanation given the current model.
...
Constrained play was designed to be ideal for correctly predicting explanations. Then what was the cause for 19.61\% to be incorrectly predicted? Analysing why players won (winners) and lost (losers) sheds more light on to this question. 
...
Table 7.2 shows that in every type of play \textit{the prediction accuracy of winners has shown to be better than that of losers}. Though there is a clear distinction in R.I.S.K between who won a game and who lost, \textit{how} they won can be generalised initially to winning a long game and winning a short game. 

Winners by definition have successfully performed their mission or will have eliminated every player, in their case they will have performed each consistent action for a mission atleast once. Therefore the shorter the game the more likely the prediction will be correct for the winner. GET DATA TO SUPPORT THIS! HYPOTHESIS?

The prediction accuracy in longer games for each

the most consistent actions but this is not necessarily true winners just like losers may be in positions where they cannot perform actions that are directly-consistent.

As by definition winners must have completed their mission, the key difference between types of winners is how well they won. For R.I.S.K. this is based on a combination of luck and skill.
...
Comparing table 7.3 to table 7.9 and 7.12 we see that in general that prediction accuracies on human players are better than on A.I. players, it is impotant to note this does not have bearings on how good either is at playing R.I.S.K.

There is though a number of reasons that may explain this.
