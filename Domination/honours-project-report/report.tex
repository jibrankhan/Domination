...
TALK ABOUT DIRECTLY AND INDIRECTLY CONSISTENT ACTIONS!
...
With the $generatePS$ operation and an idea from a paper by Goldman, Geib and Miller \cite{Goldman99anew} which proposes weighting action probabilities towards consistent actions, a method of weighting actions was then required. This was based on reasoning about the implications of an action to an explanation where consistent actions were positively weighted and inconsistent negatively weighted.

THIS SECTION NEEDS WORK

Uniform distribution

Uniform-Weighting based on number of consistent and inconsistent actions available to a player when an action is performed.
...
It required an operation that would allow greater control over weighting between consistent and inconsistent actions.
